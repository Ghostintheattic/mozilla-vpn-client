                    ...
                    RowLayout {
                        ...
                        VPNInterLabel {
                            ...
                            text: VPNServerLatency.isActive
                                ...
                                ? VPNI18n.ServersViewRecommendedRefreshLastUpdatedLabel.arg(VPNLocalizer.formatDate(VPNServerLatency.lastUpdateTime))
                                : VPNI18n.ServersViewRecommendedRefreshLastUpdatedDisabledLabel.arg(VPNLocalizer.formatDate(VPNServerLatency.lastUpdateTime))
